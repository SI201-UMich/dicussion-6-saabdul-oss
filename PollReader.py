...
class PollReader():
    ...
    def polling_history_change(self):
        ...
        early_harris = sum(self.data_dict['Harris results'][-30:]) / 30
        early_trump = sum(self.data_dict['Trump results'][-30:]) / 30
        late_harris = sum(self.data_dict['Harris results'][30:]) / 30
